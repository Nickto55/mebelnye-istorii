...
const materials = [
  {
    ...
    brands: ['Egger', 'Kronospan', 'Lamarty'],
    colors: ['Белый', 'Бежевый', 'Дуб сонома', 'Орех', 'Серый'],
    price: 'от 15 000 ₽/м²',
  ...
  },
  {
    ...
    colors: ['Любой по RAL', 'Белый матовый', 'Чёрный матовый'],
    price: 'от 25 000 ₽/м²',
  ...
  },
  {
    ...
    price: 'от 65 000 ₽/м²',
    features: ['Вечная долговечность', 'Можно реставрировать', 'Уникальный характер'],
  },
];
