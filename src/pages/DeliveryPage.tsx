...
const services = [
  {
    icon: Truck,
    title: 'Доставка',
    description: 'Доставляем мебель по Москве и Московской области. Также работаем с другими регионами России.',
    details: [
      'Москва — от 3 500 ₽',
      'Московская область — от 5 000 ₽',
